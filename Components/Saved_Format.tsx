...
import Reload_Img from "C:\\Users\\Big_T\\OneDrive\\Desktop\\VsCode\\MERN\\react-app\\src\\Components\\Images\\reload.png";
...
function Saved_Style(){
    ...
    function GetSavedItems_Database(){
        ...
        fetch('http://localhost:5000/api/Get_Pics_Vids', {
            method: 'POST',
            headers: {
            ...
            .then(response => {
                if (response.ok) {
                    console.log("From Saved Get: Request sent"); //Sent to server
                    return response.json(); 
                } else {
                    console.log("From Saved Get: Request failed"); //Failed to send server
                    return response.json(); 
                }
            })
                .then(data => {
                  if (data.success === 1) {
                    ...
                    if(documents[0] === undefined){
                        ...
                        if ((documents[0].type) === "P"){
                            ...
                            TriggerLink_Saved_1("Saved_Photo_Item_1", documents[0].url);
                            ...
                            TriggerLink_Saved_1("Saved_Video_Item_1", documents[0].url);
                            const newString = documents[0].src;
                            seturlArray_Saved(prevUrlArray => [...prevUrlArray, newString]);
                        }
                    }
                    ...
                    if(documents[1] === undefined){
                        ...
                        if ((documents[1].type) === "P"){
                            ...
                            TriggerLink_Saved_1("Saved_Photo_Item_2", documents[1].url);
                            ...
                            TriggerLink_Saved_1("Saved_Video_Item_2", documents[1].url);
                            const newString2 = documents[1].src;
                            seturlArray_Saved(prevUrlArray => [...prevUrlArray, newString2]);
                        }
                    }
                    ...
                    if(documents[2] === undefined){
                        ...
                        if ((documents[2].type) === "P"){
                            ...
                            TriggerLink_Saved_1("Saved_Photo_Item_3", documents[2].url);
                            ...
                            TriggerLink_Saved_1("Saved_Video_Item_3", documents[2].url);
                            const newString3 = documents[2].src;
                            seturlArray_Saved(prevUrlArray => [...prevUrlArray, newString3]);
                        }
                    }
                    ...
                    if(documents[3] === undefined){
                        ...
                        if ((documents[3].type) === "P"){
                            ...
                            TriggerLink_Saved_1("Saved_Photo_Item_4", documents[3].url);
                            ...
                            TriggerLink_Saved_1("Saved_Video_Item_4", documents[3].url);
                            const newString4 = documents[3].src;
                            seturlArray_Saved(prevUrlArray => [...prevUrlArray, newString4]);
                        }
                    }
                    ...
                    if(documents[4] === undefined){
                        ...
                        if ((documents[4].type) === "P"){
                            ...
                            TriggerLink_Saved_1("Saved_Photo_Item_5", documents[4].url);
                            ...
                            TriggerLink_Saved_1("Saved_Video_Item_5", documents[4].url);
                            const newString5 = documents[4].src;
                            seturlArray_Saved(prevUrlArray => [...prevUrlArray, newString5]);
                        }
                    }
                    ...
                    if(documents[5] === undefined){
                        ...
                        if ((documents[5].type) === "P"){
                            ...
                            TriggerLink_Saved_1("Saved_Photo_Item_6", documents[5].url);
                            ...
                            TriggerLink_Saved_1("Saved_Video_Item_6", documents[5].url);
                            const newString6 = documents[5].src;
                            seturlArray_Saved(prevUrlArray => [...prevUrlArray, newString6]);
                        }
                    }
                    ...
                    if(documents[6] === undefined){
                        ...
                        if ((documents[6].type) === "P"){
                            ...
                            TriggerLink_Saved_1("Saved_Photo_Item_7", documents[6].url);
                            ...
                            TriggerLink_Saved_1("Saved_Video_Item_7", documents[6].url);
                            const newString7 = documents[6].src;
                            seturlArray_Saved(prevUrlArray => [...prevUrlArray, newString7]);
                       }
                    ...
                    if(documents[7] === undefined){
                        ...
                        if ((documents[7].type) === "P"){
                            ...
                            TriggerLink_Saved_1("Saved_Photo_Item_8", documents[7].url);
                            ...
                            TriggerLink_Saved_1("Saved_Video_Item_8", documents[7].url);
                            const newString8 = documents[7].src;
                            seturlArray_Saved(prevUrlArray => [...prevUrlArray, newString8]);
                        }
                    }
                    ...
                    if(documents[8] === undefined){
                        ...
                        if ((documents[8].type) === "P"){
                            ...
                            TriggerLink_Saved_1("Saved_Photo_Item_9", documents[8].url);
                            ...
                            TriggerLink_Saved_1("Saved_Video_Item_9", documents[8].url);
                            const newString9 = documents[8].src;
                            seturlArray_Saved(prevUrlArray => [...prevUrlArray, newString9]);
                        }
                    }
                    ...
                    if(documents[9] === undefined){
                        ...
                        if ((documents[9].type) === "P"){
                            ...
                            TriggerLink_Saved_1("Saved_Photo_Item_10", documents[9].url);
                            ...
                            TriggerLink_Saved_1("Saved_Video_Item_10", documents[9].url);
                            const newString10 = documents[9].src;
                            seturlArray_Saved(prevUrlArray => [...prevUrlArray, newString10]);
                        }
                    }
    ...
    function Remove_Saved_Item_Database({src_p, src_v, numb}:Remove_Database){
        ...
        console.log("Src from Saved: ", src);
          fetch('http://localhost:5000/api/Item_Saved_Delete', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
    ...
    return(
        <div style={Main_Style} id="Main_Container">
            ...
            <button id="Reload_Btn" style={Update_Saved_List} onClick={GetSavedItems_Database}>Update List<img style={Reload_Img_Style} src={Reload_Img}/></button>
